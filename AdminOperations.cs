...
namespace InventoryManagementSystem
{
    class AdminOperations
    {
        ...
        public static void addProduct()
        {
            ...
            //while (isProductNameAvailable(productName) == null)
            //{
            //    Console.Write("Please enter product name: (Only alphabets are allowed and length must be between 4,15): ");
            //    productName = Console.ReadLine();
            //}

            //while (!Regex.Match(productName, UserOperations.alphaPattern).Success)
            //{

            //    //Console.WriteLine(isUsernameAvailable(productName));
            //    //if (productName != null)

            //    //Console.WriteLine("Null");
            //    while (!isProductNameAvailable(ctx ,productName))
            //    {
            //        Console.Write("Please enter product name: (Only alphabets are allowed and length must be between 4,15): ");
            //        productName = Console.ReadLine();
            //    }
        ...
        //public static Boolean isProductNameAvailable(MyDebContext myDbc ,string productName)
        //{
        //    //Console.WriteLine(productName);

        //    //var ctx = new MyDebContext();
        //    //var users = from data in ctx.PRODUCT_CATEGORIES select data;
        //    //var users = from prod in ctx.PRODUCT_CATEGORIES
        //    //            select prod;
        //    var user1 = myDbc.PRODUCT_CATEGORIES.Select(x => x);
        ...
        //    //    Console.WriteLine(user.Product_Name);
        //    //    if (user.Product_Name == productName)
        //    //    {
        //    //        Console.WriteLine("product exist"+ productName);
        //    //        return true;
        //    //        //return 1;
        //    //    }
        //    //}
        //    return false;
        //}
        //public static int isProductIDAvailable(int productID)
        //{
        //    var ctx = new MyDebContext();
        //    var users = from data in ctx.PRODUCT_CATEGORIES select data;
        ...
        //        if (user.Product_Category_ID == productID)
        //        {
        //            return 1;
        //        }
        //    }
        ...
        public static void getUserData()
        {
            ...
            using (var inventory = new MyDebContext())
            {
                foreach (var user in inventory.USERS.ToList())
                {
                    ...
                    //var findProductName = inventory.PRODUCTS.First(x => x.Product_Category_ID == Convert.ToInt32(findProductData.Product_Category_ID));
